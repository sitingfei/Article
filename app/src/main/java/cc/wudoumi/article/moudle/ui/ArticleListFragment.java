...
public class ArticleListFragment extends ArticleBaseLodingFragment {
    ...
    CommonCache commonCache = CommonCache.get();

    @Override
    public String getRequestTag() {
        return super.getRequestTag() + childTypeId + "----" + commonCache.getName(childTypeId) + "index:" + i;
    }
    ...
    public void onDestroyView() {
        ...
        Log.d("ArticleListFragment", "onDestroyView");
    }
    ...
    public void onDetach() {
        ...
        Log.d("ArticleListFragment", "onDetach");
    }
