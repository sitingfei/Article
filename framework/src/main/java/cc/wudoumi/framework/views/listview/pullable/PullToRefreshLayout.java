...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private LayoutParams rl = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
    ...
    public void setHfBackgroundColor(int color){
        mPullHeadView.setBackgroundColor(color);
        mPullDownFooterView.setBackgroundColor(color);
    }
